...
Потому что оне не меняет `HTML` элементы когда для этого нет необходимости. 
...
<details> 
  <summary>И я могу понять [почему](https://habrahabr.ru/post/312022/):</summary>   
...
Вот вам `5KB библиотека`, её можно использовать для быстрого обновления частей вашего сайта.
